...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full w-full overflow-x-hidden">
      <body className="flex min-h-[100dvh] w-full overflow-x-hidden flex-col bg-slate-50 text-slate-900 antialiased selection:bg-teal-600 selection:text-white">
        {/* Top Emergency & Clinical Hours Banner */}
        <div className="w-full bg-slate-950 text-slate-200 text-xs px-3 sm:px-4 py-2 border-b border-slate-800">
          <div className="w-full max-w-7xl mx-auto flex flex-col xs:flex-row items-center justify-between gap-1.5 sm:gap-4 text-center xs:text-left">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-slate-300">
                Clinic Consultations: Monday to Saturday (8:00 AM to 8:00 PM)
              </span>
            </div>
        ...
        <footer className="w-full bg-slate-950 text-slate-300 border-t border-slate-800/80 mt-16 sm:mt-24 no-print">
